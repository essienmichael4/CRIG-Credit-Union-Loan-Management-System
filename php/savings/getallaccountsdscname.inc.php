<?php
    ...
    $sql = "SELECT * FROM `savings` WHERE `account_status` != '{$status}' ORDER BY CONCAT(`first_name`,' ',`last_name`,' ',`other_names`) DESC ;";
    ...
    echo $data = "<table>
                <thead>
                    <tr>
                        <th class='orderbyid orderby dsc' onclick='idsort()'>Member ID &#9674;</th>
