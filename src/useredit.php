                ...
                <form class="form apply__form">
                    <div class="form__group less">
                        ...
                        <div class="formControl flex-c">
                            ...
                            <input type="text" placeholder="Other Name" value="<?=$user["other_names"]?>">
                        </div>
                        <div class="formControl flex-c">
                        ...
                        <div class="formControl flex-c">
                            ...
                            <input type="text" placeholder="Staff No." value="<?=$user["worker_id"]?>">
                        </div>
                        <div class="formControl flex-c">
                            <label for="">Phone Number</label>
                            <div>
                                <span>+233</span><input type="text" placeholder="eg. 201234567" value="<?=$user["phone"]?>">
                            </div>
                        </div>
                        <div class="formControl flex-c">
